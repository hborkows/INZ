...
class ESConnection:
    def __init__(self, es_host, logstash_host=None):
    ...
    def index_data_to_df(self, index_name: str, start_time: str, end_time: str, field_list: str, ):
        query = {
            "range": {
                "@timestamp": {
                    "gte": start_time,
    ...
    def ip_data_to_df(self, index_name: str, field_list: str, ip: str):
        query = {
            "bool": {
                "must": [
                    {"term": {"src_ip": ip}},
